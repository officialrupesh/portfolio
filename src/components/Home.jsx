...
const Home = () => {
    const [text] = useTypewriter({
        words: ["Frontend Developer", "Tech Enthusiast", "Software Developer"],
        loop: {},
    })
    return (
        <>
            <div name="home" className='bg-[rgba(10,25,47,1)] w-full h-screen'>
                ...
                <div className="max-w-[950px] mx-auto px-8 flex flex-col justify-center h-full text-white">
                    ...
                    <p className=' text-gray-500 py-4 max-w-[700px]'>I am currently working as Frontend Developer intern at Amnil Technologies.
                    </p>
                    <div>
